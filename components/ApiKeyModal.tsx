        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center p-4" aria-modal="true" role="dialog">
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-md transform transition-all duration-300 p-8 max-h-[90vh] overflow-y-auto">
                <div className="flex justify-between items-center mb-6">
                    <h2 className="text-2xl font-bold text-gray-800">Single API Key Settings</h2>
                ...
                <p className="text-gray-600 mb-6">
                    Configure your single Gemini API Key.
                </p>
                
                <div className="space-y-6">
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">
                            🔑 Gemini API Key (Single)
                        </label>
                        <input
                            type="password"
                            value={geminiKey}
                            onChange={(e) => setGeminiKey(e.target.value)}
                            placeholder="Enter your single Gemini API Key"
                        ...
                        />
                         <p className="text-xs text-gray-500 mt-1">Multi-key support has been disabled. Please use a single, valid API key.</p>
                    </div>
